package app.mcorg.project.domain.model.permission;
...
public record UserPermissions(String id, String username, Map<AuthorityLevel, List<Permission>> permissions) {
    ...
    public static UserPermissions create(String username) {
        return new UserPermissions(ObjectId.get().toHexString(), username,
                Map.of(AuthorityLevel.WORLD, new ArrayList<>(), AuthorityLevel.TEAM, new ArrayList<>(), AuthorityLevel.PROJECT, new ArrayList<>()));
    }
