package app.mcorg.organizer.domain.model.minecraft;
...
import static app.mcorg.organizer.domain.model.minecraft.ItemCategory.*;
import static app.mcorg.organizer.domain.model.minecraft.ItemType.*;
